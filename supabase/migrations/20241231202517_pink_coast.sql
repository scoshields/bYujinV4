/*
  # Fix Friend Activity Queries
  
  1. Changes
    - Add indexes for better performance
    - Simplify exercise completion logic
...
CREATE INDEX IF NOT EXISTS idx_user_workouts_scheduled_date 
ON user_workouts(scheduled_date);
...
-- Recreate get_friend_workouts with simplified logic
...
-- Recreate get_friend_workout_stats with simplified logic
